...
const imagemBtaotrocaDeTema = document.
...
botaoAlteraTema.addEventListener("click", () => {
    ...
    if (modoEscuroEstaAtivo) {
        imagemBtaotrocaDeTema.setAttribute("src", "./src/imagens/sun.png");
    } else {
        imagemBtaotrocaDeTema.setAttribute("src", "./src/imagens/moon.png");
    }
